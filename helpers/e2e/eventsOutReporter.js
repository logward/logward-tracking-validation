// ─────────────────────────────────────────────────────────────────────────────
//  helpers/e2e/eventsOutReporter.js
//
//  Custom Playwright reporter for E2E_Ocean.spec.js
...
//    reporter: [['./helpers/e2e/eventsOutReporter.js'], ['list']]
//
//  Or run manually after a test run:
//    node helpers/e2e/eventsOutReporter.js <playwright-json-output.json>
// ─────────────────────────────────────────────────────────────────────────────
...
class EventsOutReporter {
  ...
  onTestEnd(test, result) {
    // Only capture E2E_Ocean tests
    const file = test.location?.file || '';
    if (!file.includes('E2E_Ocean')) return;
